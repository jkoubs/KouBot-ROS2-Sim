...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/src/install/koubot_nav"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/koubot_nav/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/koubot_nav/environment/path.sh"
